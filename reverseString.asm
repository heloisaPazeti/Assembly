...
reverseString:
        ...
        lb a1, 0(s2)	            # read original string byte
        sb a1, 0(s3)	            # write byte on reversed string

        addi s2, s2, -1             # s2 = s2[k-1]
        addi s3, s3, 1              # s3 = s3[j+1]
...
printString:
        ...
        addi a7,zero,4	            # Print reversed string
		mv a0, s1
		ecall
